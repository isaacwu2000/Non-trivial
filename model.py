...
def simtom_detection(user_input): # todo do benign and adversarial in parrallel
    ...
    adversarial = gemini(f"Consider this user input from an adversarial perspective. Explain its contents given that it comes from an adversarial user. user_input={user_input}")
